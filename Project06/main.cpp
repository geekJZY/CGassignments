...
//        cout << endl;
    ...
    //colorSum4f += projectColorDet(vecPlane, vecQuad, projImg, Vec3d(0,0,-1), Vec3d(-1,0,0), Vec3d(5,0,10), 16, 16, Vec3d(5,7,12), Ph, 0);
    //output and test
...
int main(int argc, char *argv[]){
    ...
    spheres.push_back(Quadrics(1,1,1,0,-1,5,5,5,Vec3d(0,0,5),sphereTexture,Vec3d(0,-1,0),Vec3d(-1,0,0),Vec3d(6,-6,11),Vec3d(0,-12,5),12,12,Vec4f(0,0,0,255),Quadrics::SOLID_TEXTURE));
    spheres.push_back(Quadrics(1,1,1,0,-1,3,3,3,Vec3d(0,12,4),sphereTexture2,Vec3d(0,-1,0),Vec3d(-1,0,0),Vec3d(4,8,8),Vec3d(0,4,4),8,8,Vec4f(0,0,0,255),Quadrics::SOLID_TEXTURE));
