...
Quadrics::Quadrics(int a02_, int a12_, int a22_, int a21_, int a00_, double s0_, double s1_, double s2_, Vec3d pc_, int texture_, float nRR_, Vec4f ColorH0_, Vec4f ColorH1_, Vec4f ColorH2_, Vec4f ColorH3_){
    a02 = a02_;
    a12 = a12_;
    a22 = a22_;
    a21 = a21_;
...
Quadrics::Quadrics(int a02_, int a12_, int a22_, int a21_, int a00_, double s0_, double s1_, double s2_, Vec3d pc_, int texture_, float nRR_, Mat textureMap_, Vec4f ColorH3_){
    a02 = a02_;
    a12 = a12_;
    a22 = a22_;
    a21 = a21_;
...
Quadrics::Quadrics(int a02_, int a12_, int a22_, int a21_, int a00_, double s0_, double s1_, double s2_, Vec3d pc_, int texture_, float nRR_, Mat textureMap_, Vec3d planeA_, Vec3d planeX_, Vec3d planeC_, Vec3d projPoint_, float x_solid_, float y_solid_, Vec4f ColorH3_, SphereType _sphereType){
    a02 = a02_;
    a12 = a12_;
    a22 = a22_;
    a21 = a21_;
...
vector<Vec4f> Quadrics::TexColorDeter(Vec3d Ph){
    ...
    if(sphereType == HOMO){
    ...
    else if(sphereType == INFINITE_SPHERE){
        double x,y,z,phi,theta,u,v;
        int X,Y;
        Vec3d ncp = (Ph - pc)/norm(Ph - pc);
        x = ncp.dot(n0);
        y = ncp.dot(n1);
        z = ncp.dot(n2);
        phi = acos(z);
        ...
        for(int i = 0; i < 3; i ++){
            texColors[i][0] = textureMap.at<Vec3b>(Y, X)[0];
            texColors[i][1] = textureMap.at<Vec3b>(Y, X)[1];
            texColors[i][2] = textureMap.at<Vec3b>(Y, X)[2];
            texColors[i][3] = 255;
        }
    }
}
